<?php
    ...
    $result = $conn->query("SELECT thongtinvn.idvatnuoi, thongtinvn.tenvatnuoi, thongtinvn.tuoi, thongtinvn.loaivat, thongtintnv.tentnv, thongtinvn.ngaycuutro,
    thongtinvn.tinhtrang, thongtinvn.anhvatnuoi
    FROM thongtintnv RIGHT JOIN thongtinvn ON thongtintnv.idtnv = thongtinvn.idtnv");

?>
<!DOCTYPE html>
<html>
    <head>
        <title>Xem vật nuôi</title>
    ...
    <body>
        ...
        <h2>vật nuôi đã được cứu trợ</h2>
        <div class="container">
            <table class="tablevn">
                <tr>
                    <th></th>
                ...
                <?php
                    while ($rows = $result->fetch_assoc()) {
                        echo "<tr>";
                            ...
                            echo "<td>".$lv."</td>";
                            echo "<td><img src='avt.png' width ='30' heigh = '30'/><br/>".$rows['tentnv']."</td>";
